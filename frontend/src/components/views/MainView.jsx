...
export function MainView() {
  const {
    isAppEntering, activeView,
    data, dashboardDoneCount, dashboardInProgressCount, navigate, openProject,
    currentUser, activeProject, openEditProjectModal, handleTopCta, 
    projectTab, setProjectTab, projectMembers, openAddMemberModal,
    projectTasks, taskFilter, setTaskFilter, toggleSubtask, updateTaskStatus,
    openTaskDetail, projectNotes, openCreateNoteModal, openEditNoteModal,
    deleteNote, myTasks, modal, setModal
  } = useApp();
